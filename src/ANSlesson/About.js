...
<div className="flex flex-col justify-center items-center" data-aos="flip-right">
         <div className="w-[350px] sm:w-[500px] md:w-[600px] ">
          ...
          Obafemi Awolowo University, Ile-Ife, Nigeria.
             <h2 className='pt-2'>He is dedicated, open-minded, and calm. He gets across to people and adjust to changes with ease.
              He believes that a person should work on developing 
              their professional skills and learning new things all the time.
             </h2>
          
          <h2 className="pt-4 ">This website is purposely developed
           ...
           <h2 className="pt-4 ">I hope you will find the website intresting, educative, and friendly. </h2>
           </h2>
</div>
</div>
      </div>
